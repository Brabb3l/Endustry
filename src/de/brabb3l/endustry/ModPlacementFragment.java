...
public class ModPlacementFragment extends Fragment {
        ...
        parent.fill(full -> {
            ...
            full.table(frame -> {
                ...
                frame.table(categories -> {
                    ...
                    categories.addImageButton(Core.atlas.drawable("icon-" + Category.turret.name() + "-smaller"), Styles.clearToggleTransi, () -> {
                        rebuildCategory.run();
                    }).group(group).update(i -> i.setChecked(currentCategory == Category.turret)).name("category-" + Category.turret.name());
